export function FeaturesGrid() {
  return (
    <section className="py-20 bg-[#064E3B] rounded-4xl">
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        <div className="text-center mb-12">
          <span className="inline-flex items-center rounded-full border border-gray-300 px-4 py-1 text-sm font-medium mb-4 text-gray-100">
            <span className="w-2 h-2 bg-gray-100 rounded-full mr-2"></span>
            Why Choose Us
          </span>
          <h2 className="text-4xl md:text-5xl w-3xl mx-auto font-extrabold text-gray-50 leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          {/*  */}
          <div className="text-center p-8 bg-white rounded-2xl border border-red-200 shadow-sm group hover:shadow-md transition-all duration-300">
            <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-6">
               <svg className="w-8 h-8 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
